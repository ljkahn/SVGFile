...
describe('Circle', () => {
  it('should render a circle shape', () => {
    ...
    const shapeCirc = new Circle(textColor, shapeColor, text);

    expect(shapeCircle.render().toEqual(testTemp));
  })
})
...
describe('Square', () => {
  it('should render a square shape', () => {
    ...
    const shapeSquare = new Square(textColor, shapeColor, text);
...
describe('Triangle', () => {
  it('should render a trianagle shape', () => {
    ...
    const shapeTriangle = new Triangle(textColor, shapeColor, text);
